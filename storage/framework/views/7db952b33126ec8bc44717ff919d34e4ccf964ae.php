...
nav a:hover {
  color: #F70000 !important; /* Cambia este color al que prefieras */
}
...
<body>
    ...
    <div class="container-fluid">
      <a href="<?php echo e(route('inicio')); ?>" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
      ...
      <div class="collapse navbar-collapse rogelio" id="navbarToggleExternalContent">
        ...
        <ul class="navbar-nav d-flex justify-content-center w-100 navbar-nav-scroll nav-ul" style="--bs-scroll-height: 400px;">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('novedades')); ?>" class="nav-link border-effect">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('carreras')); ?>" class="nav-link border-effect">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('horarios.porCarrera')); ?>" class="nav-link border-effect">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('programas.create')); ?>" class="nav-link">
          ...
          <li class="nav-item dropdown">
            ...
            <a href="<?php echo e(route('horarios.porCarrera')); ?>" class="nav-link" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-smartwatch" viewBox="0 0 16 16">
                <path d="M9 5a.5.5 0 0 0-1 0v3H6a.5.5 0 0 0 0 1h2.5a.5.5 0 0 0 .5-.5V5z" />
                <path d="M4 1.667v.383A2.5 2.5 0 0 0 2 4.5v7a2.5 2.5 0 0 0 2 2.45v.383C4 15.253 4.746 16 5.667 16h4.666c.92 0 1.667-.746 1.667-1.667v-.383a2.5 2.5 0 0 0 2-2.45V8h.5a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5H14v-.5a2.5 2.5 0 0 0-2-2.45v-.383C12 .747 11.254 0 10.333 0H5.667C4.747 0 4 .746 4 1.667zM4.5 3h7A1.5 1.5 0 0 1 13 4.5v7a1.5 1.5 0 0 1-1.5 1.5h-7A1.5 1.5 0 0 1 3 11.5v-7A1.5 1.5 0 0 1 4.5 3z" />
              </svg>
           ...
           <!-- <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li class="nav-li">
                <a href="<?php echo e(route('horarios.porCarrera')); ?>" class="nav-link d-flex justify-content-start">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                    <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811V2.828zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                  </svg>
                  Por Carrera
              ...
              <li class="nav-li">
                <a href="<?php echo e(route('horarios.porProfesor')); ?>" class="nav-link d-flex justify-content-start">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                    <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                  </svg>
              ...
              <li class="nav-li">
                <a href="<?php echo e(route('horarios.PorDiaHora')); ?>" class="nav-link d-flex justify-content-start">
          ...
          <li class="nav-item">
            <a href="/" class="nav-link border-effect">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('nosotros')); ?>" class="nav-link border-effect">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('contacto.index')); ?>" class="nav-link">
...
<?php /**PATH C:\Users\User\Desktop\freelance\isft38\resources\views/frontend/layout/main.blade.php ENDPATH**/ ?>