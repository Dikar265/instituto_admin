	...
	/*	     .inscribite {
		...
		<!-- Carousel -->
		    ...
		    <div class="card-cronograma">
		        ...
		        <!-- <div id="novedades" class="row">
		                ...
		                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
		                    <div class="card h-100 shadow-sm border-0">
		                        <div id="carousel<?php echo e($novedad->id); ?>" class="carousel slide" data-bs-ride="carousel" data-bs-interval="12500">
		                            <div class="carousel-inner">
		                                <?php if($novedad->imagen): ?>
		                                <div class="carousel-item active">
		                                    <img src="<?php echo e(asset('./storage/' . $novedad->imagen)); ?>" alt="...">
		                                </div>
		                                <?php endif; ?>
		                                <?php if($novedad->imagen2): ?>
		                                <div class="carousel-item">
		                                    <img src="<?php echo e(asset('./storage/' . $novedad->imagen2)); ?>" alt="...">
		                                </div>
		                                <?php endif; ?>
		                                <?php if($novedad->imagen3): ?>
		                                <div class="carousel-item">
		                                    <img src="<?php echo e(asset('./storage/' . $novedad->imagen3)); ?>" alt="...">
		                                </div>
		                                <?php endif; ?>
		                            </div>
		                            <button class="carousel-control-prev" type="button" data-bs-target="#carousel<?php echo e($novedad->id); ?>" data-bs-slide="prev">
		                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
		                                <span class="visually-hidden">Previous</span>
		                            </button>
		                            <button class="carousel-control-next" type="button" data-bs-target="#carousel<?php echo e($novedad->id); ?>" data-bs-slide="next">
		                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
		                                <span class="visually-hidden">Next</span>
		                            </button>
		                        </div>
		                        <div class="card-body">
		                            <h5 class="card-title text-dark"><?php echo e($novedad->titulo); ?></h5>
		                            <div class="mt-2">
		                            <small class="text-muted  offset"> <?php echo e($novedad->updated_at->toFormattedDateString()); ?></small>
		                            </div>
		                            <p class="card-text text-secondary"><?php echo ($novedad->cuerpo); ?></p>
		                            <div class="mt-2">
		                            <?php if($novedad->deCarrera->descripcion  ?? ''): ?>
		                                    <span class="badge bg-success"><?php echo e($novedad->deCarrera->descripcion  ?? ''); ?></span>
		                            <?php endif; ?>
		                            </div>
		                            <div class="mt-2">
		                                <?php $__currentLoopData = $novedad->etiquetas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etiqueta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                                <span  class="badge bg-primary me-1"><?php echo e($etiqueta->descripcion  ?? ''); ?></span>
		                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		                            </div>
		                            <br>
		                            <div class="mt-auto">
		                                <?php if($novedad->archivo1): ?>
		                                <a href="<?php echo e(asset('./storage/' . $novedad->archivo1)); ?>" target="_blank" class="btn btn-outline-primary btn-sm d-inline-block mb-1"><?php echo e(basename($novedad->archivo1)); ?></a>
		                                <?php endif; ?>
		                                <?php if($novedad->archivo2): ?>
		                                <a href="<?php echo e(asset('./storage/' . $novedad->archivo2)); ?>" target="_blank" class="btn btn-outline-primary btn-sm d-inline-block mb-1"><?php echo e(basename($novedad->archivo2)); ?></a>
		                                <?php endif; ?>
		                                <?php if($novedad->archivo3): ?>
		                                <a href="<?php echo e(asset('./storage/' . $novedad->archivo3)); ?>" target="_blank" class="btn btn-outline-primary btn-sm d-inline-block"><?php echo e(basename($novedad->archivo3)); ?></a>
		                                <?php endif; ?>
		                            </div>
		                        </div>
		                    </div>
		        ...
		        <div class="col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="fade-up" data-aos-delay="100">
		            <div class="card h-100 shadow-sm border-0">
		                <div id="carousel<?php echo e($novedad->id); ?>" class="carousel slide tarjeta-carousel" data-bs-ride="carousel" data-bs-interval="12500">
		                    <div class="carousel-inner">
		                        <?php if($novedad->imagen): ?>
		                        <div class="carousel-item active">
		                            <!-- <img class="img-fluid" src="<?php echo e(asset('./storage/' . $novedad->imagen)); ?>" alt="..."> -->
		                            <img class="img-fluid" src="<?php echo e(url('foto_noticia/'. $novedad->imagen)); ?>" alt="...">
		                        </div>
		                        <?php endif; ?>
		                        <?php if($novedad->imagen2): ?>
		                        <div class="carousel-item">
		                           <!--  <img class="img-fluid" src="<?php echo e(asset('./storage/' . $novedad->imagen2)); ?>" alt="..."> -->
		                            <img class="img-fluid" src="<?php echo e(url('foto_noticia/'. $novedad->imagen2)); ?>" alt="...">
		                        </div>
		                        <?php endif; ?>
		                    </div>
		                     <?php if($novedad->imagen && $novedad->imagen2): ?>
		                    <button class="carousel-control-prev" type="button" data-bs-target="#carousel<?php echo e($novedad->id); ?>" data-bs-slide="prev">
		                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
		                        <span class="visually-hidden">Previous</span>
		                    </button>
		                ...
		                <div class="card-body">
		                    <h5 class="card-title text-dark"><?php echo e($novedad->titulo); ?></h5>
		                    <div class="mt-2">
		                    <!-- <small class="text-muted offset"> <?php echo e(\Carbon\Carbon::parse($novedad->updated_at)->locale('es')->translatedFormat('d F Y')); ?></small> -->
		                    </div>
		                    <p class="card-text text-secondary"><?php echo ($novedad->cuerpo); ?></p>
		                    <div class="mt-2">
		                        <?php if($novedad->deCarrera->descripcion ?? ''): ?>
		                    ...
		                    <div class="mt-2">
		                        <?php $__currentLoopData = $novedad->etiquetas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etiqueta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                        <?php if($etiqueta->nombre <> 'novedades'): ?>
		                        <span class="badge bg-primary me-1"><?php echo e($etiqueta->descripcion ?? ''); ?></span>
		                        <?php endif; ?>
		                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		                    </div>
		...
		<div id="novedades" class="fondoCards">
		        ...
		        <div class="card-container">
		    <div id="novedades" class="row">
		        <?php $__currentLoopData = $cronograma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $novedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		        <div class="col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="fade-up" data-aos-delay="100">
		            <div class="card h-100 shadow-sm border-0">
		                <div id="carousel<?php echo e($novedad->id); ?>" class="carousel slide tarjeta-carousel" data-bs-ride="carousel" data-bs-interval="12500">
		                    <div class="carousel-inner">
		                ...
		                <div class="card-body">
		                    ...
		                    <div class="mt-2">
		                        <?php $__currentLoopData = $novedad->etiquetas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etiqueta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                        <?php if($etiqueta->nombre <> 'cronograma'): ?>)
		                        <span class="badge bg-primary me-1"><?php echo e($etiqueta->descripcion ?? ''); ?></span>
		                        <?php endif; ?>
		                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		                    </div>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\freelance\isft38\resources\views/frontend/carrousel/carrousel.blade.php ENDPATH**/ ?>